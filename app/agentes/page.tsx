...
export default async function AgentesPage() {
  const [agentsRes, skillsRes, mcpsRes, agentSkillsRes, agentMcpsRes, automationsRes] = await Promise.all([
    ...
    supabase.from('automations').select('id, name, icon, status, agent_id, trigger_type, trigger_config'),
  ])
